...
-- CreateEnum
CREATE TYPE "InvoiceItemCategory" AS ENUM ('SERVICE_FEE', 'TAX_REIMBURSEMENT', 'GOV_FEE_REIMBURSEMENT', 'OUT_OF_POCKET', 'CLIENT_FUND_DEPOSIT');
...
-- CreateEnum
CREATE TYPE "JournalTransactionType" AS ENUM ('JOURNAL_ENTRY', 'INVOICE', 'PAYMENT', 'EXPENSE', 'RECEIPT', 'PETTY_CASH', 'CLIENT_FUND');
...
-- CreateEnum
CREATE TYPE "AppPortal" AS ENUM ('SALES', 'COMPLIANCE', 'LIAISON', 'ACCOUNTING', 'OPERATIONS_MANAGEMENT', 'HR', 'TASK_MANAGEMENT', 'CLIENT_RELATIONS', 'IT_MANAGEMENT');
...
-- CreateTable
CREATE TABLE "employee_team_position" (
    "id" SERIAL NOT NULL,
    "teamId" INTEGER NOT NULL,
    "positionId" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "employee_team_position_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "employee_team_position_teamId_positionId_key" ON "employee_team_position"("teamId", "positionId");
...
-- AddForeignKey
ALTER TABLE "employee_team_position" ADD CONSTRAINT "employee_team_position_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "EmployeeTeam"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "employee_team_position" ADD CONSTRAINT "employee_team_position_positionId_fkey" FOREIGN KEY ("positionId") REFERENCES "Position"("id") ON DELETE CASCADE ON UPDATE CASCADE;
