...
const PORTALS = [
  ...
  { id: 'accounting', title: 'Accounting Portal',     description: 'Handle bookkeeping, invoices, and financial reports.',href: '/portal/accounting', icon: <BarChart3 />,   color: 'bg-blue-600',    stats: { label: 'Open Invoices', value: '38' } },
