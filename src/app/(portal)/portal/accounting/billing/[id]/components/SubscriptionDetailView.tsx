          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
                <div className="flex items-start gap-3">
                  <div className="mt-0.5 p-1.5 bg-amber-100 dark:bg-amber-900/30 rounded-md">
                ...
                <div className="flex items-start gap-3">
                  <div className="mt-0.5 p-1.5 bg-emerald-100 dark:bg-emerald-900/30 rounded-md">
                ...
                <div className="flex items-start gap-3">
                  <div className="mt-0.5 p-1.5 bg-blue-100 dark:bg-blue-900/30 rounded-md">
                  ...
                  <ol className="relative space-y-0">
                    {subscription.historyLogs.map((log, idx) => (
                      <li key={log.id} className="relative pl-6 pb-6 last:pb-0">
                        ...
                        {/* Dot */}
                        <span className="absolute left-0 top-1 w-3.5 h-3.5 rounded-full bg-amber-100 border-2 border-amber-400 dark:bg-amber-900/40 dark:border-amber-500" />
