// src/app/(portal)/portal/compliance/client-compliances/[clientId]/workingpaper/[complianceSlug]/page.tsx
'use client';
...
interface Props {
  params: Promise<{ clientId: string; complianceSlug: string }>;
  searchParams: Promise<{ year?: string }>;
}

export default function ComplianceDetailPage({ params, searchParams }: Props) {
  const { clientId, complianceSlug } = use(params);
  ...
  function handleYearChange(y: number) {
    setSelectedYear(y);
    router.replace(
      `/portal/compliance/client-compliances/${clientId}/workingpaper/${complianceSlug}?year=${y}`,
      { scroll: false },
    );
  }
