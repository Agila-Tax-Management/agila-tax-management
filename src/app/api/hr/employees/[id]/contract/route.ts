...
export async function POST(request: NextRequest, { params }: RouteParams): Promise<NextResponse> {
  ...
  const contract = await prisma.employeeContract.create({
    data: {
      ...
      weeklyRate: d.weeklyRate ? parseFloat(d.weeklyRate) : null,
      ...
      payType: d.payType ?? "Variable Pay",
...
export async function PATCH(request: NextRequest, { params }: RouteParams): Promise<NextResponse> {
  ...
  const updated = await prisma.employeeContract.update({
    ...
    data: {
      ...
      weeklyRate: d.weeklyRate !== undefined ? (d.weeklyRate ? parseFloat(d.weeklyRate) : null) : undefined,
