...
export async function PATCH(request: NextRequest, { params }: RouteParams): Promise<NextResponse> {
  ...
  const updated = await prisma.employee.update({
    ...
    data: {
      ...
      currentStreet: parsed.data.currentStreet,
      currentBarangay: parsed.data.currentBarangay,
      currentCity: parsed.data.currentCity,
      currentProvince: parsed.data.currentProvince,
      currentZip: parsed.data.currentZip,
      permanentStreet: parsed.data.permanentStreet,
      permanentBarangay: parsed.data.permanentBarangay,
      permanentCity: parsed.data.permanentCity,
      permanentProvince: parsed.data.permanentProvince,
      permanentZip: parsed.data.permanentZip,
