// src/app/api/admin/settings/task-workflow/templates/[id]/routes/reorder/route.ts
...
/**
 * PATCH /api/admin/settings/task-workflow/templates/[id]/routes/reorder
 * Bulk-updates routeOrder for all department route steps in a template.
 */
