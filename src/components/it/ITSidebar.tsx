...
import {
  ...
  ClipboardList, HardDrive, Settings, Monitor,
} from 'lucide-react';
...
const IT_NAV_ITEMS = [
  ...
  { id: 'access-requests', label: 'Access Requests', icon: ShieldCheck, href: '/portal/it/access-requests' },
          ...
          {IT_NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.id === 'access-requests' && pendingAccessRequests > 0 && (
