...
import {
  Plus, Search, Ticket, ChevronDown, X, Loader2,
          ...
          {tickets.map((ticket) => (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <ChevronDown size={16} className="text-slate-300 shrink-0 mt-1" />
              </div>
            </Card>
          ))}
        </div>
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-50">
                          ...
                          <span className="text-[10px] text-slate-400 flex items-center gap-1">
                            <Clock size={10} /> {new Date(ticket.createdAt).toLocaleDateString('en-PH', { month: 'short', day: 'numeric' })}
                          </span>
                        </div>
                        {ticket.assignedTo && (
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="p-5 border-b border-slate-100 flex items-center justify-between">
              <div>
                ...
                <h3 className="font-black text-slate-900 mt-0.5">{selectedTicket.title}</h3>
              </div>
