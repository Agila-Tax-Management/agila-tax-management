// src/components/compliance/TaskDetailPage.tsx
'use client';
...
export function TaskDetailPage({
  ...
  const complianceDept = departments.find(d => /^compliance$/i.test(d.name));
  const deptStatuses = complianceDept?.statuses ?? [];
