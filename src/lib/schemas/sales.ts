...
export const createServiceSchema = z.object({
  ...
  complianceType: z.enum(["NONE", "EWT", "COMPENSATION", "PERCENTAGE", "VAT", "INCOME_TAX", "SSS", "PHILHEALTH", "PAGIBIG", "LGU_RENEWAL"]).default("NONE"),
...
export const updateServiceSchema = z.object({
  ...
  complianceType: z.enum(["NONE", "EWT", "COMPENSATION", "PERCENTAGE", "VAT", "INCOME_TAX", "SSS", "PHILHEALTH", "PAGIBIG", "LGU_RENEWAL"]).optional(),
